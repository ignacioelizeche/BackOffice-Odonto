...
def create_test_users():
    ...
    try:
        ...
        print("=" * 70)
        print("\nCreated Enterprises:")
        print(f"  • empA: ID={empA.id}, Name='{empA.name}'")
        print(f"  • empB: ID={empB.id}, Name='{empB.name}'")
        print("\nCreated Admin Users:")
        print(f"  • Admin A:")
        print(f"      Email: admin-a@clinica-a.com")
        print(f"      Password: AdminPass123!")
        print(f"      Empresa: {empA.name} (ID={empA.id})")
        print(f"  • Admin B:")
        print(f"      Email: admin-b@clinica-b.com")
        print(f"      Password: AdminPass456!")
        print(f"      Empresa: {empB.name} (ID={empB.id})")
        print("\n" + "=" * 70)
